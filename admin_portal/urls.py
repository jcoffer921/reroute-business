...
urlpatterns = [
    ...
    path("org-applications/", views.ReentryOrgApplicationListView.as_view(), name="org_application_list"),
    path("org-applications/<int:pk>/approve/", views.org_application_approve, name="org_application_approve"),
    path("org-applications/<int:pk>/reject/", views.org_application_reject, name="org_application_reject"),
